...
public class MultiHttpSecurityConfig {
    ...
    public static class App1ConfigurationAdapter extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
    		...
    		.antMatchers("/restaurantList/**").authenticated()
    		.antMatchers("/statistiques/**").authenticated()
    		.antMatchers("/series/**").authenticated()
    		.antMatchers("/specialites/**").authenticated()
    		.antMatchers("/photos/**").authenticated()
    		.antMatchers("/villes/**").authenticated()
    		.antMatchers("/zones/**").authenticated().antMatchers("/dist/**", "/fonts/**", "/img/**", "/inc/**",
    ...
    public static class App2ConfigurationAdapter extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
    		...
    		.exceptionHandling()
    		.authenticationEntryPoint(new DeniedAuthenticationEntryPoint())
    		.and().authenticationProvider(getUserProvider())
    		.formLogin()
    		.loginProcessingUrl("/login")
    		.successHandler(new AuthentificationLoginSuccessHandler())
    		.failureHandler(new UrlAuthenticationFailureHandler())
    		...
    		.authorizeRequests().antMatchers("/login").permitAll()
    		.antMatchers("/logout").permitAll()
    		.antMatchers("/index1.html").hasRole("USER")
    		.antMatchers("/restaurantList/**").authenticated()
    		.antMatchers("/zones/**").authenticated().antMatchers("/dist/**", "/fonts/**", "/img/**", "/inc/**",
					"/css/**", "/js/**", "/vendor/**", "/sass/**", "/style/**")
	.permitAll()
	.anyRequest().permitAll();
    	...
    	@Bean
    	public AuthenticationProvider getUserProvider() {
    		AppAuthProvider provider = new AppAuthProvider();
    		provider.setUserDetailsService(userDetailsService);
    		return provider;
    	}
